#!/usr/bin/env python3
"""
Test script để kiểm tra việc tìm nút "Xong"
"""
...
def test_done_button():
    ...
    try:
        ...
        from agent.youtube_share_agent import find_visibility_button, find_share_button, find_and_fill_email_field, find_done_button, debug_page_elements
        ...
        with sync_playwright() as p:
            ...
            # Test bước 4: Tìm nút Xong
            print("\n🔍 Test bước 4: Tìm nút Xong...")
            if find_done_button(page):
                print("✅ Bước 4 thành công!")
            else:
                print("❌ Bước 4 thất bại!")
...
if __name__ == "__main__":
    success = test_done_button()
    if success:
        print("\n🎉 Test nút Xong hoàn tất thành công!")
    else:
        print("\n💥 Test nút Xong thất bại!") 